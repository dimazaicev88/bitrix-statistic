...
type StatEvent struct {
	Uuid          string    `json:"uuid"`                    // ID события
	Event3        string    `json:"event3,omitempty"`        // Дополнительный параметр event3 события
	TypeUuid      string    `json:"typeUuid,omitempty"`      // ID типа события
	...
	SessionUuid   string    `json:"sessionUuid,omitempty"`   // ID сессии
	GuestUuid     string    `json:"guestUuid,omitempty"`     // ID посетителя
	HitUuid       string    `json:"hitUuid,omitempty"`       // ID хита
